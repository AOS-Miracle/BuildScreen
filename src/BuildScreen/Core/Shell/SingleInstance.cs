...
namespace BuildScreen.Core.Shell
{
    internal enum WM
    {
        NULL = 0x0000,
    ...
    /// </summary>
    /// <see href="http://blogs.microsoft.co.il/blogs/arik/archive/2010/05/28/wpf-single-instance-application.aspx"/>
    ...
    /// </summary>
    /// <remarks>
    /// This class should be used with some caution, because it does no security checking. For example,
    /// if one instance of an app that uses this class is running as Administrator, any other instance,
    /// even if it is not running as Administrator, can activate it with command line arguments. For
    /// most apps, this will not be much of an issue.
    /// </remarks>
    public static class SingleInstance<TApplication> where TApplication : Application, ISingleInstanceApp
    {
        ...
        /// <summary>
        /// Checks if the instance of the application attempting to start is the first instance. If not,
        /// activates the first instance.
        /// </summary>
        ...
        /// <summary>
        /// Gets command line args - for ClickOnce deployed applications, command line args may not be passed directly,
        /// they have to be retrieved.
        /// </summary>
        ...
        /// <summary>
        /// Creates a client channel and obtains a reference to the remoting service exposed by the server - in this case,
        /// the remoting service exposed by the first instance. Calls a function of the remoting service class to pass on
        /// command line arguments from the second instance to the first and cause it to activate itself.
        /// </summary>
        /// <param name="channelName">Application's IPC channel name.</param>
